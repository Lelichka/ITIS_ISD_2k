...
public class Database
{
    ...
    /*public IEnumerable<Account> Select<Account>()
    {
        return ExecuteQuery<Account>($"select Name,Password from Accounts");
    }
    public Account? GetById<Account>(int id)
    {
        return ExecuteQuery<Account>($"select Name,Password from Accounts where Id = {id}").FirstOrDefault();
    }
    public void Insert<Account>(string name,string password)
    {
        this.AddParameter("@Name",name)
            .AddParameter("@Password", password)
            .ExecuteNonQuery("insert into Accounts values(@Name,@Password) ");
    }*/
}
